...
const EditMatchModal: React.FC<EditMatchModalProps> = ({ isOpen, onClose, match, onSave, onDelete }) => {
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="pt-6 flex justify-between gap-3">
          <button 
            ...
            className="px-4 py-2.5 rounded-xl bg-red-500/10 text-red-500 hover:bg-red-500/20 border border-red-500/20 font-semibold transition-colors flex items-center gap-2"
          >
